{
  ...
  /*
  this.inputFormField.idnumb = this.user.profile.national_id.nationalID; //جلب رقم الموحدة
  document.getElementsByName("idnumb")[0].disabled = true; //قفل حقل رقم الموحدة
    */
}

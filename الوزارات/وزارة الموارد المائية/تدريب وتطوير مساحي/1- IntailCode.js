{
  ...
  this.inputFormField.nametwo = this.user.middle_name; //جلب الاسم الثاني
  document.getElementsByName("nametwo")[0].disabled = true; //قفل حقل الاسم الثاني
  ...
  this.inputFormField.phonenamber = this.user.phone_num; //جلب رقم الهاتف
  document.getElementsByName("phonenamber")[0].disabled = true; //قفل حقل رقم الهاتف
  ...
  //حصر حقل التاريخ
  document
    .getElementById("70045")
    .addEventListener("keydown", function (event) {
      event.preventDefault();
    });
  document.getElementsByName("datenumber")[0].setAttribute("min", "2003-01-01");
  document
    .getElementsByName("datenumber")[0]

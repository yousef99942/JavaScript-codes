{
  var Docs_ID = [
    ...
    ["three"], //الموافقة البيئية للابنية الصناعية
  ];
  var numbers = [
    1, //المجموعة الثانية
    3, //المجموعة الرابعه
  ...
  if (this.form_data.owner == "شريك في العقار") {
    validateDocuments.call(this, Docs_ID[0], numbers[0]);
    validateDocuments.call(this, Docs_ID[1], numbers[0]);
  }

  if (this.form_data.buildingtype == "صناعي") {
    validateDocuments.call(this, Docs_ID[2], numbers[1]);
  }
}

{
    First_Filter(event){
        ...
        for(var i = 0; i < Values.length; i++){
            if(event == Values[i]){
                this.group_of_form[0].fields[6].properties[0].values = getdistinct[i];
                break;
            }else{
    ...
    First_Hide(event){
        ...
        if(event == "تجاري"){
            this.group_of_form[0].fields[17].properties[0].values = [
                "محلات تجارية", "معمل", "فندق", "عمارة تجارية", "ورشة تصليح"
            ];
            document.getElementById("87876").style.display = "none"; //السكني
            document.getElementById("87875").style.display = "block"; //التجاري
        }else if(event == "صناعي"){
            this.group_of_form[0].fields[17].properties[0].values = ["ابنية حكومية"];
            document.getElementById("87876").style.display = "none"; //السكني
            document.getElementById("87875").style.display = "none"; //التجاري
        }else if(event == "سكني"){
            this.group_of_form[0].fields[17].properties[0].values = ["دار سكني", ];
            document.getElementById("87876").style.display = "block"; //السكني
            document.getElementById("87875").style.display = "none"; //التجاري
        }else{
            this.group_of_form[0].fields[17].properties[0].values = [];
            document.getElementById("87876").style.display = "none"; //السكني

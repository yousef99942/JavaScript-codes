{
  var docs_Names = [
    ["SecondAttach"], //مال اوراق تسجيل الشركة
    ["ThirdAttach"], //مال اوراق تسجيل المصنع
    ["FourthAttach"], //مال اوراق تسجيل المكتب
    ["LiscenceProve"], //مال اجازة الاستثمار
  ];
  ...
  if (this.form_data.TypeSelector == "شركة") {
    validateDocuments.call(this, docs_Names[0]);
  }

  if (this.form_data.TypeSelector == "مصنع") {
    validateDocuments.call(this, docs_Names[1]);
  }

  if (this.form_data.TypeSelector == "مكتب") {
    validateDocuments.call(this, docs_Names[2]);
  }

  if (this.form_data.TypeSelector == "مشروع استثماري") {
    validateDocuments.call(this, docs_Names[3]);
  }
}

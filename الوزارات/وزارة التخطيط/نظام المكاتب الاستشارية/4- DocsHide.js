{
  ...
  if (Selected_Values.includes(this.form_data.Procedure)) {
    ...
    //تعهد بعدم وجود اي التزام لدى المكتب
    document.getElementsByClassName("47218")[0].style.display = "none";
    //طلب خطي لتجميد المكتب مع بيان اسباب التجميد
    document.getElementsByClassName("47219")[0].style.display = "none";
  }

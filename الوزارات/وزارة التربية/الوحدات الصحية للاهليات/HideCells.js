{
    getsubCities(event) {
        ...
        var getdistinct = [
            ...
            Selected_Values = [
                "الانبار", "بابل", "بغداد", "البصرة", "ديالى", "ذي قار", "صلاح الدين", "القادسية", "كركوك", "كربلاء المقدسة", "المثنى",
                "ميسان", "النجف الاشرف", "نينوى", "واسط"
            ];

        for(var i = 0; i < Selected_Values.length; i++){
            if(event == Selected_Values[i]){
                this.group_of_form[0].fields[19].properties[0].values = getdistinct[i];
            }
        }
    },
}
{
    First_Hide(event){
        this.inputFormField["namedata"] = null; // امر اخر تجديد
        if(event == "لا"){
            document.getElementById("73278").style.display = "block";
        }else{
            document.getElementById("73278").style.display = "none";
        }
    },
    ...
    First_Filter(event){
        ...
        for(var i = 0; i < Values.length; i++){
            if(event == Values[i]){
                this.group_of_form[0].fields[10].properties[0].values = getdistinct[i];
                break;
            }else{

//Write your code here
{
  ...
  if (this.form_data.compIncorTypeRequest != "مخول") {
    document.getElementsByClassName("23330")[1].style.display = "none";
  ...
  if (this.form_data.compIncorProjloc == "داخل حدود بلدية المحافظة") {
    ...
    if (
      ...
      document.getElementsByClassName("24590")[1].style.display = "block";
      delete this.inputDocsField["compIncorDocOutpartAcc"];
      console.log("okKo");
      document.getElementsByClassName("24592")[1].style.display = "none";
      ...
      document.getElementsByClassName("24590")[1].style.display = "none";
      document.getElementsByClassName("24592")[1].style.display = "none";
    }
  ...
  // if (this.form_data.compIncorProjloc == "خارج حدود بلدية المحافظة")
    ...
    if (this.form_data.compIncorProjProp == "حق تصرف من دائرة عقارات الدولة") {
      document.getElementsByClassName("24592")[1].style.display = "block";
      document.getElementsByClassName("24590")[1].style.display = "none";
    } else {
      document.getElementsByClassName("24592")[1].style.display = "none";
      document.getElementsByClassName("24590")[1].style.display = "none";
  ...
  if (this.form_data.compIncorBrand != "نعم") {
    document.getElementsByClassName("21178")[1].style.display = "none";
  }

  var xx = "24591";
  document.getElementsByClassName(xx)[3].style.display = "none";
}

{
  var docs_Names = [
    ["DocFFF"], //المستمسكات مال الزوج او الزوجة
    ["docmother"], //المستمسكات مال اخ او اخت من جهة الام
    ["DocEE"], //المستمسكات مال حفيد شهيد
  ];
  ...
  if (this.form_data.family == "زوج / زوجة") {
    validateDocuments.call(this, docs_Names[0]);
  }

  if (this.form_data.family == "اخ / اخت - من جهة الام") {

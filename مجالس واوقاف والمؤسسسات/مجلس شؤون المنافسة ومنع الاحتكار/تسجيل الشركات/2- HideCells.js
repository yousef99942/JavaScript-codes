{
    //نوع الشركة
    First_Hide(event){
        this.inputFormField["SecondOtherText"] = null; // اذكر نوع الشركة الاخر 

        if(event == "اخرى"){
            document.getElementById("87784").style.display = "block"; // اذكر نوع الشركة الاخر 
        }else{
            document.getElementById("87784").style.display = "none"; // اذكر نوع الشركة الاخر 
        }
    },

    //جنسية الشركة
    Second_Hide(event){
        this.inputFormField["ThirdOtherText"] = null; // اذكر جنسية الشركة الاخرى 

        if(event == "اخرى"){
            document.getElementById("87785").style.display = "block"; // اذكر جنسية الشركة الاخرى 
        }else{
            document.getElementById("87785").style.display = "none"; // اذكر جنسية الشركة الاخرى 
        }
    },

    //قطاع الشركة
    Third_Hide(event){
        this.inputFormField["OtherText"] = null; // اذكر القطاع الاخر 

        if(event == "اخرى"){
            document.getElementById("87782").style.display = "block"; // اذكر القطاع الاخر 
        }else{
            document.getElementById("87782").style.display = "none"; // اذكر القطاع الاخر 
        }
    },
    ...
    First_Filter(event){
        ...
        for(var i = 0; i < Values.length; i++){
            if(event == Values[i]){
                this.group_of_form[0].fields[15].properties[0].values = getdistinct[i];
                break;
            }else{

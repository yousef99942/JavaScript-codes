{
    transtypeway(event){
        ...
        if (event == "بري"){
            document.getElementById("28891").style.display = "block"; 
        }else{
            document.getElementById("28891").style.display = "none"; 
        }
    },
    ...
    First_Hide(event){
        ...
        if(event == "البطاقة الوطنية"){
            document.getElementById("73208").style.display = "block"; 
            document.getElementById("28875").style.display = "none"; 
        }else if(event == "جواز السفر"){
            document.getElementById("73208").style.display = "none"; 
            document.getElementById("28875").style.display = "block"; 
        }else{
            document.getElementById("73208").style.display = "none"; 
            document.getElementById("28875").style.display = "none";
        }
    ...
    getsubCities(event) {
        ...
        if(Values.includes(event)){
            document.getElementById("73767").style.display = "block"; //سلكتر القضاء
            ...
            document.getElementById("74865").style.display = "none"; //اسم القضاء
        }
        }else if(Second_Values.includes(event)){
            document.getElementById("74865").style.display = "block"; //اسم القضاء
            document.getElementById("73767").style.display = "none"; //سلكتر القضاء
        }else{
            document.getElementById("73767").style.display = "none"; //سلكتر القضاء
            document.getElementById("74865").style.display = "none"; //اسم القضاء
        }
    ...
    Second_Hide(event){
        var Progs = [
            ...
            "isode", //هل تم التنسيق بين الجهة المرخصة بالنقل والحماية الامنية على موعد تحريك الشحنة
        ...
        if(event == "الفئة 1" || event == "الفئة 2"){
            //تفاصيل الحماية الامنية
            document.getElementById("11796_group").style.display = "block";
        }else{
            //تفاصيل الحماية الامنية

{
    ...
    First_Hide(event){
        //يرجى تحديد الكمية المستخدمة بشكل تقريبي  الكمية/ لتر
        this.inputFormField["iok"] = null;
        this.inputFormField["qax"] = null;
        if(event == "نعم"){
            document.getElementById("73914").style.display = "block";
            document.getElementById("73915").style.display = "block"; //انواع الاوساط الزراعية المستخدمة
        }else{
            document.getElementById("73914").style.display = "none";
    ...
    Second_Hide(event){
        var Selected_Values = [
            "بكتـــريا", "فايروســـات", "فطريــات",
        ];

        this.inputFormField["boyy"] = null;
        if(event.length != 0){
            for(var i = 0; i < event.length; i++){
                if(Selected_Values.includes(event[i])){
                    document.getElementById("73899").style.display = "block";
                    break;
                }else{
                    document.getElementById("73899").style.display = "none";
                }
            }
        }else{
            document.getElementById("73899").style.display = "none";
    ...
    Third_Hide(event){
        ...
        if(event.length != 0){
            for(var i = 0; i < event.length; i++){
                if(Selected_Values.includes(event[i])){
                    document.getElementById("73905").style.display = "block";
                    break;
                }else{
                    document.getElementById("73905").style.display = "none";
                }
            }
        }else{
            document.getElementById("73905").style.display = "none";
    ...
    Fourth_Hide(event){
        ...
        if(event.length != 0){
            for(var i = 0; i < event.length; i++){
                if(Selected_Values.includes(event[i])){
                    document.getElementById("73907").style.display = "block";
                    break;
                }else{
                    document.getElementById("73907").style.display = "none";
                }
            }
        }else{
            document.getElementById("73907").style.display = "none";
    ...
    Fifth_Hide(event){
        ...
        this.inputFormField["erty"] = null; //السموم : اسم السم المستخدم ومصدره
        if(event.length != 0){
            for(var i = 0; i < event.length; i++){
                if(Selected_Values.includes(event[i])){
                    document.getElementById("73912").style.display = "block";
                    break;
                }else{
                    document.getElementById("73912").style.display = "none";
                }
            }
        }else{
            document.getElementById("73912").style.display = "none";

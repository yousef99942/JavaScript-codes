{
  nukelinc(event) {
    var x = event;
    if (event === "اجازة جديدة") {
        document.getElementById("34588").style.display = "block";
        this.inputFormField["vrl"] = null;
        document.getElementById("34595").style.display = "none";
        this.inputFormField["ert"] = null;
    }else{
      document.getElementById("34588").style.display = "none";
      this.inputFormField["vrl"] = null;
      document.getElementById("34595").style.display = "block";
      this.inputFormField["ert"] = null;
    }
  },
  ...
  getsubCities(event) {
        ...
        for(var i = 0; i < Values.length; i++){
            if(event == Values[i]){
                this.group_of_form[2].fields[3].properties[0].values = getdistnict[i];
                break;
            }else{
                this.group_of_form[2].fields[3].properties[0].values = [];
            }
        }
    },
}
{
    First_Hide(event){
        ...
        if(event == "البطاقة الوطنية"){
            document.getElementById("27238").style.display = "none";
            document.getElementById("73116").style.display = "block";
        }else if(event == "جواز السفر"){
            document.getElementById("27238").style.display = "block";
            document.getElementById("73116").style.display = "none";
        }else{
            document.getElementById("27238").style.display = "none";
            document.getElementById("73116").style.display = "none";
        }
    ...
    getsubCities(event) {
        ...
        if(Values.includes(event)){
            document.getElementById("73595").style.display = "block"; //سلكتر الاقضية
            for(var i = 0; i < Values.length; i++){
            if(event == Values[i]){
                this.group_of_form[0].fields[2].properties[0].values = getdistnict[i];
                break;
            }else{
                this.group_of_form[0].fields[2].properties[0].values = [];
            }

            document.getElementById("74867").style.display = "none"; //حقل اسم القضاء
        }
        }else if(Second_Values.includes(event)){
            document.getElementById("74867").style.display = "block"; //حقل اسم القضاء
            document.getElementById("73595").style.display = "none"; //سلكتر الاقضية
        }else {
            document.getElementById("73595").style.display = "none"; //سلكتر الاقضية
            document.getElementById("74867").style.display = "none"; //حقل اسم القضاء
        }

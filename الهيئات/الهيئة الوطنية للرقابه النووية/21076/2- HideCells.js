{
    First_Hide(event){
        this.inputFormField["numb"] = null;//رقم الاجازة
        this.inputFormField["dat"] = null;//تاريخ الاجازة

        if(event == "تجديد اجازة" || event == "تعديل اجازة"){
            document.getElementById("48038").style.display = "block"; //رقم الاجازة
            document.getElementById("48039").style.display = "block"; //تاريخ الاجازة
        }else{
            document.getElementById("48038").style.display = "none"; //رقم الاجازة
            document.getElementById("48039").style.display = "none"; //تاريخ الاجازة
        }
    },
    ...
    getsubCities(event) {
        ...
        for(var i = 0; i < Values.length; i++){
            if(event == Values[i]){
                this.group_of_form[0].fields[11].properties[0].values = getdistnict[i];
                break;
            }else{

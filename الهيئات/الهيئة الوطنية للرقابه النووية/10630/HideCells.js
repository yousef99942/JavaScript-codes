{
    getsubCities(event) {
        ...
        if(Values.includes(event)){
            document.getElementById("73601").style.display = "block"; //سلكتر القضاء
            ...
            document.getElementById("74866").style.display = "none"; //اسم القضاء
        }
        }else if(Second_Values.includes(event)){
            document.getElementById("74866").style.display = "block"; //اسم القضاء
            document.getElementById("73601").style.display = "none"; //سلكتر القضاء
        }else{
            document.getElementById("73601").style.display = "none"; //سلكتر القضاء
            document.getElementById("74866").style.display = "none"; //اسم القضاء
        }
    ...
    First_Hide(event){
        this.inputFormField["idcard"] = null;//رقم الموحدة
        this.inputFormField["ress"] = null;//رقم جواز السفر

        if(event == "البطاقة الموحدة"){
            document.getElementById("65680").style.display = "block"; //رقم الموحدة
            document.getElementById("29155").style.display = "none"; //رقم جواز السفر
        }else if(event == "جواز السفر"){
            document.getElementById("65680").style.display = "none"; //رقم الموحدة
            document.getElementById("29155").style.display = "block"; //رقم جواز السفر
        }else{
            document.getElementById("65680").style.display = "none"; //رقم الموحدة
            document.getElementById("29155").style.display = "none"; //رقم جواز السفر
        }

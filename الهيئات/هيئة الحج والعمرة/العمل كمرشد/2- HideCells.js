{
    getsubCities(event) {
        ...
        if(Result){
            this.group_of_form[1].fields[1].properties[0].values = Result.Showed_Value;
        }else{
    ...
    First_Hide(event){
        ...
        if(event == "موظف"){
            document.getElementById("92112").style.display = "block";
        }else{
            document.getElementById("92112").style.display = "none";
        }
    }
}
{
    ...
    First_Check(event){
        const Companies = [
            ...
            { Company_Name: "احباب الاقصى للحج والعمرة محدودة المسؤولية", Password: "JD@81" },
            { Company_Name: "نسيم المواسم للحج والعمرة محدودة المسؤولية", Password: "PF@82" },
            { Company_Name: "اضواء الكواز للسفر والسياحة المحدودة", Password: "XC@83" },
            { Company_Name: "ميزان الرحمة للحج والعمرة محدودة المسؤولية", Password: "BN@84" },
            { Company_Name: "نور البنين للحج والعمرة محدودة المسؤولية", Password: "QH@85" },
            { Company_Name: "المناسك الذهبية للحج والعمرة محدودة المسؤولية", Password: "VK@86" },
            { Company_Name: "الحلو الذهبية للنقل العام ونقل المسافرين والحج والعمرة محدودة المسؤولية", Password: "RM@87" },
            { Company_Name: "نسك المدينة للحج والعمرة محدودة المسؤولية", Password: "TG@88" },
            { Company_Name: "طريق الحق للحج والعمرة محدودة المسؤولية", Password: "LW@89" },
            { Company_Name: "الحرم الامين للحج والعمرة محدودة المسؤولية", Password: "CY@90" },
            { Company_Name: "رحلة العراق للسفر والسياحة محدودة المسؤولية", Password: "EA@91" },
            { Company_Name: "انوار المكين للحج والعمرة محدودة المسؤولية", Password: "UZ@92" },
            { Company_Name: "ضيوف البيت للحج والعمرة محدودة المسؤولية", Password: "KS@93" },
            { Company_Name: "اضواء مكة للحج والعمرة ونقل المسافرين محدودة المسؤولية", Password: "MD@94" },
            { Company_Name: "طيبة النوار للحج والعمرة محدودة المسؤولية", Password: "JN@95" },
            { Company_Name: "السداد للحج والعمرة محدودة المسؤولية", Password: "HA@96" },
            { Company_Name: "طريق اسيا للسفر والسياحة", Password: "QL@97" },
            { Company_Name: "احباب القريشي للسفر والسياحة محدودة المسؤولية", Password: "WR@98" },
            { Company_Name: "رفاه المسافات للحج والعمرة محدودة المسؤولية", Password: "ZT@99" },
            { Company_Name: "برج الساعة للحج والعمرة محدودة المسؤولية", Password: "MK@01" },
            { Company_Name: "ريحانة الصفا للحج والعمرة ونقل المسافرين محدودة المسؤولية", Password: "PV@02" },
            { Company_Name: "الدمام المتحدة للحج والعمرة محدودة المسؤولية", Password: "DU@03" },
            { Company_Name: "اضواء الحرمين للحج والعمرة المحدودة", Password: "AH@04" },
            { Company_Name: "الشريف للحج والعمرة محدودة المسؤولية", Password: "SH@05" },
            { Company_Name: "اهل العربية للسفر والسياحة المحدودة", Password: "AA@06" },
            { Company_Name: "التون هلال تور للحج والعمرة ونقل المسافرين المحدودة", Password: "TH@07" },
            { Company_Name: "احباب التقى المنيرة للحج والعمرة محدودة المسؤولية", Password: "AM@08" },
            { Company_Name: "رحلة المناسك للحج والعمرة محدودة المسؤولية", Password: "RM@09" },
            { Company_Name: "ساحل اللاذقية للسفر والسياحة محدودة المسؤولية", Password: "SL@10" },
            { Company_Name: "قمة الاهرام للسفر والسياحة محدودة المسؤولية", Password: "QA@12" },
            { Company_Name: "المقام للحج والعمرة محدودة المسؤولية", Password: "MQ@13" },
            { Company_Name: "ذهب كركوك للحج والعمرة محدودة المسؤولية", Password: "DK@14" },
            { Company_Name: "طريق المروة للحج والعمرة المحدودة", Password: "TM@15" },
            { Company_Name: "ارض الرافدين للحج والعمرة محدودة المسؤولية", Password: "AR@16" },
            { Company_Name: "تيجان الانبار للحج والعمرة محدودة المسؤولية", Password: "TA@17" },
            { Company_Name: "المعتمر للحج والعمرة محدودة المسؤولية", Password: "MA@18" },
            { Company_Name: "القسم للحج والعمرة محدودة المسؤولية", Password: "AQ@19" },
            { Company_Name: "فيض القسم للسفر والسياحة محدودة المسؤولية", Password: "FQ@20" },
            { Company_Name: "الأيمان الجابرة للحج والعمرة محدودة المسؤولية", Password: "AJ@21" },
            { Company_Name: "ديار طيبة لنقل المسافرين والحج والعمرة محدودة المسؤولية", Password: "DT@22"},
            { Company_Name: "اجنحة السعادة للسفر والسياحة محدودة المسؤولية", Password: "QX@23"},
            { Company_Name: "انوار المواكب للحج والعمرة المحدودة", Password: "VK@24"},
            { Company_Name: "مجد الحرمين للحج والعمرة", Password: "MH@25"},
            { Company_Name: "نور العلياء للسفر والسياحة محدودة المسؤولية", Password: "NP@26"},
            { Company_Name: "روعة المناسك للحج والعمرة", Password: "RW@27"},
            { Company_Name: "الرزعامة لنقل المسافرين والحج والعمرة محدودة المسؤولية", Password: "ZC@28"},
            { Company_Name: "احباب مكة للحج والعمرة ونقل المسافرين محدودة المسؤولية", Password: "BY@29"},
        ];
